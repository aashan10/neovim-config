" Name:         aashan
" Description:  VIM colorscheme inspired by habamax.
" Author:       Ashan Ghimire<ashanghimire10@gmail.com>
" Maintainer:   Ashan Ghimire<ashanghimire10@gmail.com>
...
hi! link @type.php Normal
hi! link @type.definition.php Normal
hi! link @type.qualifier.php Statement
hi! link @variable.parameter.phpdoc Statement 
hi! link @variable.php Statement
hi! link @operator.php Normal
hi! link @constructor.php Type
hi! link @punctuation.bracket.php Statement
hi! link @punctuation.delimiter.php Normal
hi! link @attribute.phpdoc Statement
hi! link @type.builtin.php Statement
hi! link @punctuation.bracket.php Normal
hi @variable.php guifg=#CE9865
hi @function.method.call.php guifg=#61AFEE
hi @type.builtin.php guifg=#C678DE
hi Normal guifg=#bcbcbc guibg=#1c1c1c gui=NONE cterm=NONE
hi Statusline guifg=#9e9e9e guibg=#1c1c1c gui=NONE cterm=NONE
...
hi Folded guifg=#9e9e9e guibg=#3A3A3A gui=NONE cterm=NONE
...
hi DiffDelete guifg=#000000 guibg=#FDA9A7 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi DiffDelete ctermfg=137 ctermbg=108 cterm=NONE
...
if s:t_Co >= 16
  ...
  hi DiffDelete ctermfg=black ctermbg=#FDA9A7 cterm=NONE
...
" Color: colorB           #3A3A3A        235            darkgrey
